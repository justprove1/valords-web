      ...
      <div className="shell">
        ...
        <FadeUp i={1}>
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginTop: 44 }}>
            <Link to="/contact" className="btn btn--light">Arrange a viewing</Link>
            <Link to="/sell" className="btn btn--light">Value my property</Link>
          </div>
        </FadeUp>

        <div className="footer-grid" style={{ marginTop: 'clamp(60px,9vh,120px)', borderTop: '1px solid rgba(246,244,239,.16)', paddingTop: 40 }}>
          <div>
            <p className="eyebrow" style={{ color: 'var(--stone)' }}>Office</p>
            <p style={{ margin: '10px 0 0', lineHeight: 1.7 }}>
              Carrer del Mestre Nicolau, 2<br />08021 Barcelona
            </p>
          </div>
          <div>
            <p className="eyebrow" style={{ color: 'var(--stone)' }}>Contact</p>
            <p style={{ margin: '10px 0 0', lineHeight: 1.7 }}>
          ...
          <div>
            <p className="eyebrow" style={{ color: 'var(--stone)' }}>Navigate</p>
            <p style={{ margin: '10px 0 0', lineHeight: 1.9, display: 'grid' }}>
              <Link to="/collection" className="ul" style={{ justifySelf: 'start' }}>The Collection</Link>
              <Link to="/barcelona" className="ul" style={{ justifySelf: 'start' }}>Barcelona</Link>
              <Link to="/sell" className="ul" style={{ justifySelf: 'start' }}>Sell your property</Link>
            </p>
          </div>
          <div>
            <p className="eyebrow" style={{ color: 'var(--stone)' }}>Follow</p>
            <p style={{ margin: '10px 0 0', lineHeight: 1.9, display: 'grid' }}>
