...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ja(e,t,n){let r=new Float32Array(Pa),i=new G(0,1,0);return new vi({name:`SphericalGaussianBlur`,defines:{n:Pa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ya(){return new vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(){return new vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Za(),fragmentShader:`
	...
	`}var Qa=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ws={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ts(e,t){let n=ws[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Es=new G;function Ds(){return q.getLuminanceCoefficients(Es),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Es.x.toFixed(4)}, ${Es.y.toFixed(4)}, ${Es.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
